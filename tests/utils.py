...
from src.common.statics    import (ACCOUNT_CHECK_QUEUE, ACCOUNT_SEND_QUEUE, COMMAND, COMMAND_DATAGRAM_HEADER,
                                   ...
                                   GATEWAY_QUEUE, GROUP_ID_LENGTH, GROUP_MESSAGE_HEADER, GROUP_MGMT_QUEUE,
                                   GROUP_MSG_ID_LENGTH, GROUP_MSG_QUEUE, GUI_INPUT_QUEUE, INITIAL_HARAC,
                                   ...
                                   M_A_HEADER, M_E_HEADER, M_L_HEADER, M_S_HEADER, ONION_CLOSE_QUEUE, ONION_KEY_QUEUE,
                                   PADDING_LENGTH, PRIVATE_MESSAGE_HEADER, PUB_KEY_CHECK_QUEUE, PUB_KEY_SEND_QUEUE,
                                   RELAY_PACKET_QUEUE, RX_BUF_KEY_QUEUE, SENDER_MODE_QUEUE, SRC_TO_RELAY_QUEUE,
                                   ...
                                   TOR_DATA_QUEUE, TRAFFIC_MASKING_QUEUE, TRUNC_ADDRESS_LENGTH, TX_BUF_KEY_QUEUE,
