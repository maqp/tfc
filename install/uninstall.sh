...
sudo rm -f /usr/share/applications/tfc-relay.desktop
sudo rm -f /usr/share/applications/tfc-relay-qubes.desktop
sudo rm -f /usr/share/applications/tfc-relay-tails.desktop
sudo rm -f /usr/share/applications/tfc-receiver-qubes.desktop
sudo rm -f /usr/share/applications/tfc-transmitter.desktop
sudo rm -f /usr/share/applications/tfc-transmitter-qubes.desktop
