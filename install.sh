...
function arg_error {
    ...
    echo    "  tcb      Install Transmitter/Receiver Program (Debian 11 / PureOS 10.0 / *buntu 22.04 / Pop!_OS 22.04 / LMDE 5 / Mint 21.1 / Zorin OS 16.2)"
    echo    "  relay    Install Relay Program                (Debian 11 / PureOS 10.0 / *buntu 22.04 / Pop!_OS 22.04 / LMDE 5 / Mint 21.1 / Zorin OS 16.2 / Tails 5.12)"
    echo -e "  local    Install insecure local testing mode  (Debian 11 / PureOS 10.0 / *buntu 22.04 / Pop!_OS 22.04 / LMDE 5 / Mint 21.1 / Zorin OS 16.2)\n"
    echo    "  qsrc     Install Transmitter Program          (Qubes 4.1.2)"
    echo    "  qdst     Install Receiver Program             (Qubes 4.1.2)"
    echo -e "  qnet     Install Relay Program                (Qubes 4.1.2)\n"
    exit 1
}
